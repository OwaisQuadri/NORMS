    ...
    <section class="page-section bg-light" id="pricing">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">PALCEHOLDER</h3>
            </div>
                    ...
                    <!-- Portfolio item 1-->
                        <div class="portfolio-item shadow pt-0 ">
                            ...
                            <div class="portfolio-caption">
                                ...
                                <p class="portfolio-caption-subheading text-muted">$' . $row['Price'] . ' per day</p>
                                </div>
                            ...
                            <form class="form-horizontal" action="/action_page.php">
                                ...
                                <div class="form-group">
                                    <div class="row justify-content-center my-2">
                                        ...
                                        <div class="col-md-10 "></div>
                                            ...
                                            <div class="col-md-4 p-1"><input type="address" class="form-control" id="st" placeholder="Street Address" name="address" required ></div>
                                            <div class="col-md-2 p-1"><input type="address" class="form-control" id="city" placeholder="City" name="city" required ></div>
                                            <div class="col-md-2 p-1"><input type="address" class="form-control" id="prov" placeholder="Province/State" name="prov" required ></div>
                                            <div class="col-md-2 p-1"><input type="address" class="form-control" id="country" placeholder="Country" name="country" required ></div>
                                            <div class="col-md-2 p-1"><input type="address" class="form-control" id="postal" placeholder="PostalCode" name="postal" required ></div>
                                    </div>
                                </div>
                                <hr>
                                <div class="form-group">
                                    <div class="row justify-content-center my-2">
                                        ...
                                        <div class="col-md-3">
                                            <input type="date" class="form-control" id="pickup" placeholder="PICKUP" name="pickup">
                                        </div>
                                        <label class="col-md-3 control-label text-center p-2" for="dropoff">Drop Date:</label>
                                        <div class="col-md-3">
                                            <input type="date" class="form-control" id="dropoff" placeholder="DROPOFF" name="dropoff">
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                <div class="form-group">
                                    <div class="row justify-content-center my-2">
                                        ...
                                        <div class="col-md-4">
                                        <input id="ccn" class="form-control" type="tel" inputmode="numeric" pattern="[0-9\s]{13,19}" autocomplete="cc-number" maxlength="19" placeholder="xxxx xxxx xxxx xxxx" required>
                                        </div>
                                        <div class="col-md-3">
                                        <input id="cvv" class="form-control" type="tel" inputmode="numeric" pattern="[0-9]{3}" maxlength="3" placeholder="CVV" required>
                                        </div>
                                        <div class="col-md-3">
                                        <input id="expiry" type="date" class="form-control" placeholder="Expiry" required>
                                        </div>
                                        </div>
                                        </div>
                                        <br>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary text-uppercase text-white">Pay Now</button>
                                    </div>
                                </div>
                            </form>
                            </div>
